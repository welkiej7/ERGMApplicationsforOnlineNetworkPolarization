...
def generate_user_space(n_users:int, 
    ...
    del TMP_aligned_array, core_polarized # No point to keep them in memory.
    ...
    for COL in range(n_cleavage, n_cleavage + n_non_cleavage):
        ...
        user_space[:,COL] = TMP_aligned_array
    del TMP_aligned_array, core_non_polarized # No point to keep them in memory
